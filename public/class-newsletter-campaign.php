 ...
 * functionality, then refer to `class-newsletter-campaign-admin.php`
 *
 * @package NewsletterCampaign
 * @author  Fisu <tommybfisher@gmail.com>
 */
class NewsletterCampaign {
	...
	/**
	 * @TODO - Rename "newsletter-campaign" to the name of your plugin
	 *
	 ...
	 * @var      string
	 */
	protected $plugin_slug = 'newsletter-campaign';
	...
	private static function single_activate() {
		// Refresh the permalink structure for the custom post types
        flush_rewrite_rules();
	}
